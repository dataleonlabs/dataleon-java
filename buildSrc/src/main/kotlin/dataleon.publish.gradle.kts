    ...
    publications {
        register<MavenPublication>("maven") {
            ...
            pom {
                ...
                url.set("https://www.github.com/dataleonlabs/dataleon-java")
                ...
                scm {
                    connection.set("scm:git:git://github.com/dataleonlabs/dataleon-java.git")
                    developerConnection.set("scm:git:git://github.com/dataleonlabs/dataleon-java.git")
                    url.set("https://github.com/dataleonlabs/dataleon-java")
                }
