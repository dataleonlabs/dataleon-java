    ...
    publications {
        register<MavenPublication>("maven") {
            ...
            pom {
                ...
                url.set("https://www.github.com/stainless-sdks/dataleon-java")
                ...
                scm {
                    connection.set("scm:git:git://github.com/stainless-sdks/dataleon-java.git")
                    developerConnection.set("scm:git:git://github.com/stainless-sdks/dataleon-java.git")
                    url.set("https://github.com/stainless-sdks/dataleon-java")
                }
