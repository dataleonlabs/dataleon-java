...
dependencies {
    testImplementation(project(":dataleon-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../dataleon-java-core/src/main/resources/META-INF/proguard/dataleon-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.dataleon.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../dataleon-java-core/src/main/resources/META-INF/proguard/dataleon-java-core.pro",
