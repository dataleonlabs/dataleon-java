...
package com.dataleon.api.client.okhttp
...
/**
 * A class that allows building an instance of [DataleonClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class DataleonOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [DataleonClientAsync]. */
         ...
         */
        @JvmStatic fun fromEnv(): DataleonClientAsync = builder().fromEnv().build()
    }

    /** A builder for [DataleonOkHttpClientAsync]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [com.dataleon.api.core.jsonMapper]. The default is usually sufficient and
         ...
         *
         * Defaults to the production environment: `https://inference.eu-west-1.dataleon.ai`.
         */
        ...
        /**
         * Returns an immutable instance of [DataleonClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DataleonClientAsync =
            DataleonClientAsyncImpl(
                clientOptions
                    .httpClient(
