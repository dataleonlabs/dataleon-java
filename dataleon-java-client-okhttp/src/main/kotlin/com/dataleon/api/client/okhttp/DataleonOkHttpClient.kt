...
import com.dataleon.api.client.DataleonClientImpl
...
/**
 * A class that allows building an instance of [DataleonClient] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class DataleonOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [DataleonClient]. */
         ...
         */
        @JvmStatic fun fromEnv(): DataleonClient = builder().fromEnv().build()
    }

    /** A builder for [DataleonOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [DataleonClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DataleonClient =
            DataleonClientImpl(
                clientOptions
                    .httpClient(
