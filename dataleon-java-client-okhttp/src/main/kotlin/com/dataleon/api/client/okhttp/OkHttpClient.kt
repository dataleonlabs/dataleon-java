...
import com.dataleon.api.core.http.HttpRequestBody
import com.dataleon.api.core.http.HttpResponse
import com.dataleon.api.errors.DataleonIoException
...
class OkHttpClient private constructor(private val okHttpClient: okhttp3.OkHttpClient) :
    ...
    override fun execute(request: HttpRequest, requestOptions: RequestOptions): HttpResponse {
        ...
        return try {
            ...
            throw DataleonIoException("Request failed", e)
        } finally {
            request.body?.close()
        }
    }
            ...
            .enqueue(
                object : Callback {
                    ...
                    override fun onFailure(call: Call, e: IOException) {
                        future.completeExceptionally(DataleonIoException("Request failed", e))
                    }
                }
            )
    ...
    private fun newCall(request: HttpRequest, requestOptions: RequestOptions): Call {
        ...
        val logLevel =
            when (System.getenv("DATALEON_LOG")?.lowercase()) {
        ...
        if (logLevel != null) {
            clientBuilder.addNetworkInterceptor(
                HttpLoggingInterceptor().setLevel(logLevel).apply { redactHeader("Api-Key") }
            )
        }
