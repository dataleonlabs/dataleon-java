...
[![Maven Central](https://img.shields.io/maven-central/v/com.dataleon.api/dataleon-java)](https://central.sonatype.com/artifact/com.dataleon.api/dataleon-java/0.0.1-alpha.1)
[![javadoc](https://javadoc.io/badge2/com.dataleon.api/dataleon-java/0.0.1-alpha.1/javadoc.svg)](https://javadoc.io/doc/com.dataleon.api/dataleon-java/0.0.1-alpha.1)
...
Javadocs are available on [javadoc.io](https://javadoc.io/doc/com.dataleon.api/dataleon-java/0.0.1-alpha.1).
...
```kotlin
implementation("com.dataleon.api:dataleon-java:0.0.1-alpha.1")
```
