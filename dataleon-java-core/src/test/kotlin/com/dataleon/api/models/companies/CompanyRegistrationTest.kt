...
internal class CompanyRegistrationTest {

    @Test
    fun create() {
        val companyRegistration =
            CompanyRegistration.builder()
                .addAmlSuspicion(
                    CompanyRegistration.AmlSuspicion.builder()
                        ...
                        .status(CompanyRegistration.AmlSuspicion.Status.PENDING)
                        .type(CompanyRegistration.AmlSuspicion.Type.PEP)
                        .build()
                )
                .certificat(
                    CompanyRegistration.Certificat.builder()
                        .id("cert_123")
                ...
                .addMember(
                    CompanyRegistration.Member.builder()
                        ...
                        .source(CompanyRegistration.Member.Source.USER)
                        .state("PROCESSED")
                        .status("approved")
                        .type(CompanyRegistration.Member.Type.PERSON)
                        .workspaceId("wk_123")
                        .build()
                )
                .portalUrl("https://portal.dataleon.ai/e/123")
                .addProperty(
                    CompanyRegistration.Property.builder()
                        .name("property_name")
                        .type("string")
                ...
                .risk(
                    CompanyRegistration.Risk.builder()
                        .code("20030")
        ...
        assertThat(companyRegistration.amlSuspicions().getOrNull())
            .containsExactly(
                CompanyRegistration.AmlSuspicion.builder()
                    .caption("Suspicious activity")
                    .country("FR")
        ...
        assertThat(companyRegistration.certificat())
            .contains(
                CompanyRegistration.Certificat.builder()
                    .id("cert_123")
                    .createdAt(OffsetDateTime.parse("2025-05-01T12:00:00Z"))
        ...
        assertThat(companyRegistration.checks().getOrNull())
            .containsExactly(
                Check.builder()
                    .masked(false)
                    .message("Name matched successfully")
        ...
        assertThat(companyRegistration.company())
            .contains(
                CompanyRegistration.Company.builder()
                    .address("123 Rue de Paris, 75001 Paris, France")
                    .closureDate(LocalDate.parse("2025-12-31"))
        ...
        assertThat(companyRegistration.documents().getOrNull())
            .containsExactly(
                GenericDocument.builder()
                    .id("doc_123")
                    .addCheck(
        ...
        assertThat(companyRegistration.members().getOrNull())
            .containsExactly(
                CompanyRegistration.Member.builder()
                    .id("123e4567-e89b-12d3-a456-426614174000")
                    .address("456 Avenue de Lyon, 69000 Lyon, France")
        ...
        assertThat(companyRegistration.portalUrl()).contains("https://portal.dataleon.ai/e/123")
        assertThat(companyRegistration.properties().getOrNull())
            .containsExactly(
                CompanyRegistration.Property.builder()
                    .name("property_name")
                    .type("string")
        ...
        assertThat(companyRegistration.risk())
            .contains(
                CompanyRegistration.Risk.builder()
                    .code("20030")
                    .reason("Document mismatch")
        ...
        assertThat(companyRegistration.sourceId()).contains("src-001")
        ...
        assertThat(companyRegistration.webviewUrl()).contains("https://id.dataleon.ai/e/123")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedCompanyRegistration =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(companyRegistration),
                jacksonTypeRef<CompanyRegistration>(),
            )

        assertThat(roundtrippedCompanyRegistration).isEqualTo(companyRegistration)
    }
}
