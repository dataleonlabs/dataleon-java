...
internal class IndividualTest {
    ...
    fun create() {
        ...
        assertThat(individual.id()).contains("123e4567-e89b-12d3-a456-426614174000")
        assertThat(individual.amlSuspicions().getOrNull())
            .containsExactly(
                Individual.AmlSuspicion.builder()
                    .caption("Suspicious activity")
                    .checked(true)
        ...
        assertThat(individual.authUrl()).contains("https://id.dataleon.ai/a/123")
        ...
        assertThat(individual.checks().getOrNull())
            .containsExactly(
                Check.builder()
                    .masked(false)
                    .message("Name matched successfully")
        ...
        assertThat(individual.documents().getOrNull())
            .containsExactly(
                GenericDocument.builder()
                    .id("doc_123")
                    .addCheck(
        ...
        assertThat(individual.number()).contains(42L)
        ...
        assertThat(individual.portalUrl()).contains("https://portal.dataleon.ai/w/123")
        assertThat(individual.properties().getOrNull())
            .containsExactly(
                Individual.Property.builder()
                    .name("property_name")
                    .type("string")
        ...
        assertThat(individual.sourceId()).contains("ID54410069066")
        assertThat(individual.state()).contains("WAITING")
        assertThat(individual.status()).contains("rejected")
        assertThat(individual.tags().getOrNull())
            .containsExactly(
                Individual.Tag.builder()
                    .key("tag_name")
                    .private_(false)
        ...
        assertThat(individual.webviewUrl()).contains("https://id.dataleon.ai/w/123")
        assertThat(individual.workspaceId()).contains("wk_123")
    }
