...
/**
 * A client for interacting with the Dataleon REST API asynchronously. You can also switch to
...
interface DataleonClientAsync {
     ...
     */
    fun withOptions(modifier: Consumer<ClientOptions.Builder>): DataleonClientAsync
    ...
    /**
     * A view of [DataleonClientAsync] that provides access to raw HTTP responses for each method.
     */
