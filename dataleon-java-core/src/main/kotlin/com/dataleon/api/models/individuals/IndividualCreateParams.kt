...
private constructor(
     ...
     */
    fun person(): Optional<Person> = body.person()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [IndividualCreateParams].
         *
    ...
    /** A builder for [IndividualCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(individualCreateParams: IndividualCreateParams) = apply {
            body = individualCreateParams.body.toBuilder()
            additionalHeaders = individualCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = individualCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [IndividualCreateParams].
         *
         ...
         */
        fun build(): IndividualCreateParams =
        ...
        class Gender @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
            ...
            fun known(): Known =
                when (this) {
                    M -> Known.M
                    F -> Known.F
                    else -> throw DataleonInvalidDataException("Unknown Gender: $value")
                }
