...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CompanyListParams && endDate == other.endDate && limit == other.limit && offset == other.offset && sourceId == other.sourceId && startDate == other.startDate && state == other.state && status == other.status && workspaceId == other.workspaceId && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
