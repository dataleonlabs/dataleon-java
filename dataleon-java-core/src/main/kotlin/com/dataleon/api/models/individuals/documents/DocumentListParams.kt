...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(documentListParams: DocumentListParams) = apply {
            individualId = documentListParams.individualId
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is DocumentListParams && individualId == other.individualId && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(individualId, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "DocumentListParams{individualId=$individualId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
