...
private constructor(
    ...
    fun document(): Optional<Boolean> = Optional.ofNullable(document)
    ...
    companion object {
        ...
        @JvmStatic fun none(): IndividualRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        fun document(document: Optional<Boolean>) = document(document.getOrNull())
