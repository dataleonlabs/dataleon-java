...
interface DocumentService {
    ...
    fun list(individualId: String): DocumentResponse = list(individualId, DocumentListParams.none())
    ...
    fun list(
        individualId: String,
        params: DocumentListParams = DocumentListParams.none(),
    ): DocumentResponse = list(individualId, params, RequestOptions.none())
    ...
    fun upload(individualId: String, params: DocumentUploadParams): GenericDocument =
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun list(individualId: String): HttpResponseFor<DocumentResponse> =
        ...
        fun list(
            individualId: String,
            params: DocumentListParams = DocumentListParams.none(),
        ): HttpResponseFor<DocumentResponse> = list(individualId, params, RequestOptions.none())
        ...
        fun upload(
            individualId: String,
            params: DocumentUploadParams,
        ): HttpResponseFor<GenericDocument> = upload(individualId, params, RequestOptions.none())
