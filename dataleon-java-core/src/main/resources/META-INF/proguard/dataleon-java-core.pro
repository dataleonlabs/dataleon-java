...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.dataleon.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.dataleon.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.dataleon.api.** {
    <init>(...);
